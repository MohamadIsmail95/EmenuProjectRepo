...
{
    /// <inheritdoc />
    public partial class InitialEmenuDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VarId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAttributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductAttributes_Attributes_AttributId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAttributes_Variants_VarId",
                        column: x => x.VarId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductAttId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImages_ProductAttributes_ProductAttId",
                        column: x => x.ProductAttId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_AttributId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_VarId",
                table: "ProductAttributes",
                column: "VarId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ProductAttId",
                table: "ProductImages",
                column: "ProductAttId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_ArabicName",
                table: "Products",
                column: "ArabicName",
                unique: true);
